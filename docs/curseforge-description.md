...
Tally isn't here to replace the great tools you already use — it's built to augment them. [TSM](https://www.curseforge.com/wow/addons/tradeskill-master) handles pricing data and posting rules. [FlipQueue](https://www.curseforge.com/wow/addons/flipqueue) handles cross-realm flipping. [Auctionator](https://www.curseforge.com/wow/addons/auctionator) handles shopping. Tally pulls them all into one dashboard where you can see what you own, what it's worth, how it's evolving, and where the gold is going.
...
Per-item research that combines pricing across every TSM source, your sales history (when [FlipQueue](https://www.curseforge.com/wow/addons/flipqueue) is installed), where the item lives across your characters, and how its price and inventory have moved over time.
...
### [Syndicator](https://www.curseforge.com/wow/addons/syndicator) (required)
...
### [TradeSkillMaster](https://www.curseforge.com/wow/addons/tradeskill-master) (recommended)
...
### [FlipQueue](https://www.curseforge.com/wow/addons/flipqueue) (recommended)
...
### Sibling cogs in the [Chronoforge](https://www.curseforge.com/wow/addons/cogworks) suite

Tally ships alongside [Cogworks](https://www.curseforge.com/wow/addons/cogworks) (shared library), [FlipQueue](https://www.curseforge.com/wow/addons/flipqueue) (auction-house workflow), [Tempo](https://www.curseforge.com/wow/addons/tempo) (daily/weekly task cadence), and [Maxcraft](https://www.curseforge.com/wow/addons/maxcraft) (profession planning). Each is fully functional standalone; together they share the suite-wide minimap chrome and themable UI.
...
- **[Syndicator](https://www.curseforge.com/wow/addons/syndicator)** is a hard dependency — Tally uses it as the single source of truth for inventory across all your characters

Recommended (greatly enhanced experience but optional):
- **[TradeSkillMaster](https://www.curseforge.com/wow/addons/tradeskill-master)** for pricing
- **[FlipQueue](https://www.curseforge.com/wow/addons/flipqueue)** for sales history in `/tally research`

---

## Getting Started

1. Install Tally alongside [Syndicator](https://www.curseforge.com/wow/addons/syndicator) and (optionally) [TradeSkillMaster](https://www.curseforge.com/wow/addons/tradeskill-master)
